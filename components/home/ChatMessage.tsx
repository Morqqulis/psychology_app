			...
			<TouchableOpacity
				...
				<View
					style={[
						styles.bubble,
						{
							backgroundColor: message.isUser ? Colors[them].chatBubbleUser : Colors[them].chatBubbleAI,
					...
					{message.type === 'text' ?
						<Text
							style={[
								styles.text,
								{
									color: message.isUser ? Colors[them].chatTextUser : Colors[them].chatTextAI,
								},
							]}>
							{message.text}
						</Text>
					...
					<Text
						style={[
							styles.timestamp,
							{
								color: message.isUser ? 'rgba(255,255,255,0.7)' : Colors[them].icon,
							},
						]}>
